...
### 测试版 [![](https://img.shields.io/maven-central/v/org.glavo.hmcl/hmcl-dev?label=测试版)](https://search.maven.org/artifact/org.glavo.hmcl/hmcl-dev/3.5.3.225/pom)

下载测试版 v3.5.3.225:

* `.exe`：[hmcl-dev-3.5.3.225.exe](https://maven.aliyun.com/repository/central/org/glavo/hmcl/hmcl-dev/3.5.3.225/hmcl-dev-3.5.3.225.exe)
* `.jar`：[hmcl-dev-3.5.3.225.jar](https://maven.aliyun.com/repository/central/org/glavo/hmcl/hmcl-dev/3.5.3.225/hmcl-dev-3.5.3.225.jar)
...
* `.jar`: https://maven.aliyun.com/repository/central/org/glavo/hmcl/hmcl-dev/3.5.3.225/hmcl-dev-3.5.3.225.jar
* `.pack`: https://maven.aliyun.com/repository/central/org/glavo/hmcl/hmcl-dev/3.5.3.225/hmcl-dev-3.5.3.225.pack
* `.pack.gz`: https://maven.aliyun.com/repository/central/org/glavo/hmcl/hmcl-dev/3.5.3.225/hmcl-dev-3.5.3.225.pack.gz
* `.pack.xz`: https://maven.aliyun.com/repository/central/org/glavo/hmcl/hmcl-dev/3.5.3.225/hmcl-dev-3.5.3.225.pack.xz
* `.json`: https://maven.aliyun.com/repository/central/org/glavo/hmcl/hmcl-dev/3.5.3.225/hmcl-dev-3.5.3.225.json
