...
### 测试版 [![](https://img.shields.io/maven-central/v/org.glavo.hmcl/hmcl-dev?label=测试版)](https://search.maven.org/artifact/org.glavo.hmcl/hmcl-dev/3.5.9.259/pom)

下载测试版 v3.5.9.259:

* `.exe`：[hmcl-dev-3.5.9.259.exe](https://maven.aliyun.com/repository/central/org/glavo/hmcl/hmcl-dev/3.5.9.259/hmcl-dev-3.5.9.259.exe)
* `.jar`：[hmcl-dev-3.5.9.259.jar](https://maven.aliyun.com/repository/central/org/glavo/hmcl/hmcl-dev/3.5.9.259/hmcl-dev-3.5.9.259.jar)
...
* `.jar`: https://maven.aliyun.com/repository/central/org/glavo/hmcl/hmcl-dev/3.5.9.259/hmcl-dev-3.5.9.259.jar
* `.json`: https://maven.aliyun.com/repository/central/org/glavo/hmcl/hmcl-dev/3.5.9.259/hmcl-dev-3.5.9.259.json
