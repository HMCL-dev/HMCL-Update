...
### 测试版 [![](https://img.shields.io/maven-central/v/org.glavo.hmcl/hmcl-dev?label=测试版)](https://search.maven.org/artifact/org.glavo.hmcl/hmcl-dev/3.5.3.223/pom)

下载测试版 v3.5.3.223:

* `.exe`：[hmcl-dev-3.5.3.223.exe](https://maven.aliyun.com/repository/central/org/glavo/hmcl/hmcl-dev/3.5.3.223/hmcl-dev-3.5.3.223.exe)
* `.jar`：[hmcl-dev-3.5.3.223.jar](https://maven.aliyun.com/repository/central/org/glavo/hmcl/hmcl-dev/3.5.3.223/hmcl-dev-3.5.3.223.jar)
...
* `.jar`: https://maven.aliyun.com/repository/central/org/glavo/hmcl/hmcl-dev/3.5.3.223/hmcl-dev-3.5.3.223.jar
* `.pack`: https://maven.aliyun.com/repository/central/org/glavo/hmcl/hmcl-dev/3.5.3.223/hmcl-dev-3.5.3.223.pack
* `.pack.gz`: https://maven.aliyun.com/repository/central/org/glavo/hmcl/hmcl-dev/3.5.3.223/hmcl-dev-3.5.3.223.pack.gz
* `.pack.xz`: https://maven.aliyun.com/repository/central/org/glavo/hmcl/hmcl-dev/3.5.3.223/hmcl-dev-3.5.3.223.pack.xz
* `.json`: https://maven.aliyun.com/repository/central/org/glavo/hmcl/hmcl-dev/3.5.3.223/hmcl-dev-3.5.3.223.json
